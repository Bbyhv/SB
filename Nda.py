...
client = LineClient(authToken='EoS02ORbL90zuRZbcmP4.qF09O2f5la8k8iTKqk0KHa.TYTcKX/LW/lo7tRbyWKTtGvARikbOJn2RgRlAzvN3zs=')
                            ...
                            if text.lower() == 'me':
                                ...
                                try:
                                    ...
                                    for i in range(len(st)):
                                        ...
                                        channel.comment(str(sender), str(result), 'Auto Like by Item')
