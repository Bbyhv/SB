...
#=========================================================================================================================================#
            ...
            if op.type == 22:
                ...
                if settings["autoLeave"] == True:
                    client.sendMessage(op.param1, "Nah ada yg invite")
                    client.leaveRoom(op.param1)

            if op.type == 24:
                print ("[ 24 ] NOTIFIED LEAVE ROOM")
                if settings["autoLeave"] == True:
                    client.sendMessage(op.param1, "Nah Ada yg Leave")
                    client.leaveRoom(op.param1)
            ...
            if op.type == 26:
                ...
                if msg.text != None:
                    ...
                    pass
            if op.type == 15:
                client.sendText(op.param1,"Wa'alaikumsallam " + client.getContact(op.param2).displayName +  "\nSampai Jumpa Lagi . . . (p′︵‵。) 🤗")
                    ...
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                pref=['eh ada kak','hai kak','lg ngapain kak','halo kak','sini masuk kak','hayo ngintip','ayo sini gabung kak','Waalaikumsallam Silahkan Masuk kak']
